...
# Registra os Middlewares de Auditoria Sarak (Camada L7)
register_sarak_middleware(identity_middleware)
register_sarak_middleware(tenant_middleware)

# Registra os Overrides Oficiais (Inversão de Dependência)
register_sarak_dependency_override(get_db, _get_identity_db)
register_sarak_dependency_override(get_current_user, get_real_current_user)
